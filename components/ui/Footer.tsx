  ...
  return (
    <div className="px-4 overflow-hidden w-full mt-9 max-w-7xl bg-accent/0 ">
      ...
      <div className="p-4 mt-8 mb-8 flex flex-col sm:flex-row justify-center items-center gap-2 md:gap-4 lg:gap-8  ">
        ...
        {/* ── Social networks ─────────────────────────────────────────────────────── */}
        <div className="flex justify-center items-center shrink-0 gap-9 lg:gap-9 sm:gap-3 md:gap-4 p-2">
        ...
        {/* ── Text ─────────────────────────────────────────────────────── */}
        <div className="flex flex-col justify-center items-start text-shadow-lg gap-2">
          <Dialog>
            <DialogTrigger asChild>
              <div className="hover:underline text-wrap cursor-pointer hover:underline-offset-4 hover:shadow-none font-normal text-sm leading-5">
                ...
                <div className="text-sm text-gray-700 leading-relaxed space-y-6">
                  ...
                  <section>
                    ...
                    <p>
                      ...
                      (сервис Яндекс.Почта). Данные никогда не будут переданы
                  ...
                  <section>
                    ...
                    <p>
                      Срок обработки данных неограничен. Вы можете в любой
